...
| `service-worker.js` | Offline cache | Bumped to `br-portuguese-v2` |
...
- [ ] **Category 02** — Replace `Greetings` with fresh **Brazilian Greetings & Everyday Phrases** (pt-BR informal `Oi, E aí, Beleza?`, formal `Bom dia`, `Com licença`) — keep 18-20 items, pronunciation not needed but keep `🔊`
...
*Maintained by: Bodeo — 2026-08-28 — Next sprint: Category 02 Brazilian Greetings*
