const database = {
  ...
  "Articles": [
    ["O","Definite — Masc. Sing. 'the' — o livro (the book) — [oo] as in boot"],
    ["Os","Definite — Masc. Pl. 'the' — os livros (the books) — [ooz/oosh]"],
    ["A","Definite — Fem. Sing. 'the' — a casa (the house) — [ah] as in father"],
    ["As","Definite — Fem. Pl. 'the' — as casas (the houses) — [ahz/ash]"],
    ["Um","Indefinite — Masc. Sing. 'a/an' — um carro (a car)"],
    ["Uns","Indefinite — Masc. Pl. 'some' — uns carros (some cars)"],
    ["Uma","Indefinite — Fem. Sing. 'a/an' — uma maçã (an apple)"],
    ["Umas","Indefinite — Fem. Pl. 'some' — umas maçãs (some apples)"],
    ["O gato / Os gatos","the male cat(s) — O gato dorme (the cat sleeps)"],
    ["A cadeira / As cadeiras","the chair(s) — A cadeira é nova"],
    ["O telefone / Os telefones","the telephone(s) — O telefone toca"],
    ["O amigo / Os amigos","the male friend(s) — O amigo é legal"],
    ["A praia / As praias","the beach(es) — A praia é linda"],
    ["O jornal / Os jornais","the newspaper(s) — O jornal de hoje"],
    ["Um cachorro / Uns cachorros","a dog / some dogs — Um cachorro late"],
    ["Uma caneta / Umas canetas","a pen / some pens — Uma caneta azul"],
    ["Um relógio / Uns relógios","a watch / some watches — Um relógio caro"],
    ["Um avião / Uns aviões","an airplane / some airplanes — Um avião grande"],
    ["Uma xícara / Umas xícaras","a cup / some cups — Uma xícara de café"],
    ["Uma cidade / Umas cidades","a city / some cities — Uma cidade grande"],
    ["O problema","Masc. despite -a (Greek -ema) — o problema é difícil"],
    ["O sistema / O clima / O tema","Masc. -ema/-ama — o sistema, o clima tropical, o tema difícil"],
    ["A nação / A cidade / A viagem","Fem. -ção/-dade/-gem — a nação, a cidade, a viagem"],
    ["O dia / O mapa / O planeta","Masc. -a false friend — o dia lindo, o mapa antigo"],
    ["A foto (fotografia)","Fem. shortened — a foto (from a fotografia)"],
    ["A moto (motocicleta)","Fem. shortened — a moto (from a motocicleta)"],
    ["O pneu (pneumático)","Masc. shortened — o pneu (from o pneumático)"],
    ["O cinema","Masc. -a — o cinema fechou (the cinema closed)"]
  ],
    ["Um / Uma", "A / An (masc./fem.)"]
  ],
